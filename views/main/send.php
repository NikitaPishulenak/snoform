	...
	<div class="col-md-6">
		<div>
			<h2>Уважаемый участник!<br>
                Поздравляем! Вы прошли регистрацию!</h2>
        ...
        <div>
        	<h3 class="blueColor">КОНТАКТЫ:</h3>
                <strong class="colorInfo">Председатель СНО БГМУ</strong><br>
                    Давидян Артур Валерьевич<br>
                    Телефон: +375-29-980-53-08<br><br>

                    <strong class="colorInfo">Заместитель председателя СНО БГМУ </strong><br>
                    по информационно-издательской и организационной работе<br>
                    Подголина Алена Александровна<br>
                    Телефон: +375-29-586-46-54<br><br>

                    <strong class="colorInfo">Заместитель председателя СНО БГМУ </strong><br>
                    по внутривузовским и межуниверситетским коммуникациям<br>
                    Пристром Игорь Юрьевич<br>
                    ...
                    Совет Студенческого научного общества</em>
        </div>
    </div>
	<div class="col-md-6">
		<div>
			<h2>Dear participant!<br>
                Congratulations! You have been registered!</h2>
        ...
        <div>
        	<h3 class="blueColor">CONTACTS:</h3>
                <strong class="colorInfo">Chairman of Student Scientific Society of BSMU</strong><br>
                    ...
                    Council of Student Scientific Society</em>
        </div>
	</div>
</div>
